...
-subj "/C=GB/ST=London/L=London/O=ratracejoe/OU=BX/CN=juliet.${LOCAL_STACK_HOST}.nip.io"
...
[alt_names]
DNS.1 = localhost
DNS.2 = juliet.${LOCAL_STACK_HOST}.nip.io
...
-subj "/C=GB/ST=London/L=London/O=ratracejoe/OU=BX/CN=the-nurse.${LOCAL_STACK_HOST}.nip.io"
...
[alt_names]
DNS.1 = localhost
DNS.2 = the-nurse.${LOCAL_STACK_HOST}.nip.io
IP.1 = ${LOCAL_STACK_HOST}
EOF
