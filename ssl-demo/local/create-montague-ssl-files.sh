...
-subj "/C=GB/ST=London/L=London/O=ratracejoe/OU=BX/CN=romeo.${LOCAL_STACK_HOST}.nip.io"
...
[alt_names]
DNS.1 = localhost
DNS.2 = romeo.${LOCAL_STACK_HOST}.nip.io
...
-subj "/C=GB/ST=London/L=London/O=ratracejoe/OU=BX/CN=tybalt.${LOCAL_STACK_HOST}.nip.io"
...
[alt_names]
DNS.1 = localhost
DNS.2 = tybalt.${LOCAL_STACK_HOST}.nip.io
IP.1 = ${LOCAL_STACK_HOST}
EOF
